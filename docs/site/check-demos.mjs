...
assert(!privateData.test(app.replaceAll("dropout-tech/dev-skills", "")), "only the fork's own repo slug may mention dropout");
...
assert(html.includes('data-host-picker') && html.includes('dropout-tech'));
